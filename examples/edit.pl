...
my $zoom = div( { style => "font-size:$size" . "px;text-align:center;" },
                a(  {  -href  => './edit.pl?style=Crystal&size=16',
                       -class => "treeviewLink$size"
                    },
                    '16'
                    )
                    . '&#160;|&#160;'
                    . a( {  -href  => './edit.pl?style=Crystal&size=22',
                            -class => "treeviewLink$size"
                         },
                         '22'
                    )
                    . '&#160;|&#160;'
                    . a( {  -href  => './edit.pl?style=Crystal&size=32',
                            -class => "treeviewLink$size"
                         },
                         '32'
                    )
                    . '&#160;|&#160;'
                    . a( {  -href  => './edit.pl?style=Crystal&size=48',
                            -class => "treeviewLink$size"
                         },
                         '48'
                    )
